				...
				<nav id="main-nav">
					<ul class="clearfix">
						...
						<!-- ${sessionScope['scopedTarget.shoppingCart'].quantity}
							...
							(ponto) no nome, somos obrigados a acessar a chave através da sintaxe 
							de mapa. Apenas por curiosidade, a variável com o nome sessionScope 
							está sempre disponível nas JSPs para que que você tenha acesso diretamente 
							ao mapa de variáveis que estejam neste escopo. O mesmo acontece com os 
							objetos que estão no request, que ficam disponíveis através do $requestScope. 
							...
							carrinho de compras. Como foi escolhida a estratégia baseada no proxy, 
							o framework coloca os objetos no escopo com esse prefixo, justamente 
							para poder dar um tratamento diferenciado internamente. Caso tivéssemos 
							optado pela abordagem de trocar o escopo do nosso controller pelo 
							request e, não houvesse a necessidade de trocar a maneira como 
							criamos os objetos do tipo ShoppingCart, o Spring MVC teria colocado 
							na sessão a variável com o mesmo nome da classe e nossa JSP funcionaria 
							tranquilamente. Lembre-se sempre que tudo é uma troca: quando decidimos 
							ir por um caminho temos que ter em mente que, talvez, um preço seja cobrado. -->
			...
			<div id="product-overview" class="container">
				...
				<p itemprop="description" class="book-description">
					${product.description} Veja o <a
						href="<c:url value='/${product.summaryPath}'/>" target="_blank">sum
					</a> completo do livro!
				</p>
			</div>
		</header>
